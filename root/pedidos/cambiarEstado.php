    ...
    <a href="../main/main.php"><button class="btn btn-default"><img src="../../icons/actions/arrow-left.png" /><strong> Volver</strong></button></a>
	   ...
	   <div class="col-sm-5">
	    <div class="input-group">
	     <span class="input-group-addon">Código Producto</span>
	      <input id="text" type="text" class="form-control" name="cod_prod" value="<?php echo $line['cod_prod']; ?>" readonly required>
	    </div></div>
	   
	   <div class="col-sm-5">
	   <div class="input-group">
	      <span class="input-group-addon">Descripción</span>
	      <input id="text" type="text" class="form-control" name="descripcion" value="<?php echo $line['descripcion']; ?>" readonly required>
	    </div></div></div></div><hr>
	   ...
	   <div class="col-sm-5">
	    <div class="input-group">
	     <span class="input-group-addon">Importe $</span>
	      <input id="text" type="text" class="form-control" name="importe" value="<?php echo $line['importe']; ?>" readonly required>
	    </div></div>
	   ...
	   <div class="col-sm-5">
	    <div class="input-group">
	     <span class="input-group-addon">Talle</span>
	      <input id="number" type="text" class="form-control" name="talle" value="<?php echo $line['talle']; ?>" readonly required>
	    </div></div></div></div><hr>
	  ...
	  <div class="input-group">
	     <span class="input-group-addon">Provincia</span>
	      <input id="text" type="text" class="form-control" name="cl_provincia" value="<?php echo $line['provincia']; ?>" readonly required>
	    </div></div></div></div><hr>
