  ...
  <div class="container text-center">
    ...
    <a href="../main/main.php"><button class="btn btn-default"><img src="../../icons/actions/arrow-left.png" /><strong> Volver</strong></button></a>
	  ...
	  <div class="panel panel-success" >
	      ...
	      <span class="pull-center "><img src="../../icons/actions/list-add.png"  class="img-reponsive img-rounded"> Productos - Editar Registro
	      </div>
	      <br>
	   ...
	   <div class="col-sm-5">
	    <div class="input-group">
	     <span class="input-group-addon">Código Producto</span>
	      <input id="text" type="text" class="form-control" name="cod_prod" value="<?php echo $fila['cod_prod']; ?>" required>
	    </div></div>
	   ...
	   <div class="col-sm-5">
	    ...
	    <option value="N" <?php if($fila['tipo'] == "N") echo 'selected'; ?>>Normal</option>
	    <option value="D" <?php if($fila['tipo'] == "D") echo 'selected'; ?>>Destacado</option>
	    </select>
	  </div>
	  </div>
	  </div>
