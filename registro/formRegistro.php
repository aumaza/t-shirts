	   ...
	   <div class="col-sm-5">
	    <div class="input-group">
	     <span class="input-group-addon">Nombre</span>
	      <input id="text" type="text" class="form-control" name="nombre" value="<?php echo $nombre; ?>" readonly required>
	    </div></div>
	   ...
	   <div class="col-sm-5">
	    <div class="input-group">
	     <span class="input-group-addon">Password</span>
	      <input id="text" type="password" class="form-control" name="pass1" required>
	    </div></div>
	   
	   <div class="col-sm-5">
	    <div class="input-group">
	     <span class="input-group-addon">Repita Password</span>
	      <input id="text" type="password" class="form-control" name="pass2" required>
	    </div></div></div></div><hr>
