...
<html lang="es">
<head>
  <title>Usuario - Registro Actualizado</title>
  <meta charset="utf-8">
  ...
  <div class="container text-center">
    ...
    <a href="../main/main.php"><button class="btn btn-default"><img src="../../icons/actions/arrow-left.png" /><strong> Volver</strong></button></a>
	 ...
	 if($conn){
		...
		$sql = "update clientes set nombre = '$nombre', email = '$email', celular = '$celular', direccion = '$direccion', localidad = '$localidad', provincia = '$provincia' where id = '$id'";
