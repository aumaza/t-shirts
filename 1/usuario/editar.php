  ...
  <div class="container text-center">
    ...
    <a href="../main/main.php"><button class="btn btn-default"><img src="../../icons/actions/arrow-left.png" /><strong> Volver</strong></button></a>
	  ...
	  <div class="panel panel-success" >
	      ...
	      <span class="pull-center "><img src="../../icons/actions/document-edit.png"  class="img-reponsive img-rounded"> Usuario - Editar Datos
	      </div>
	      <br>
	   ...
	   <div class="col-sm-5">
	    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" value="<?php echo $fila['nombre'] ?>" readonly required/>
                    </div></div>
                    
                    <div class="col-sm-5">
                    <div class="form-group">
                        <label for="inputEmail">Email</label>
                        <input type="email" class="form-control" name="email" value="<?php echo $fila['email']; ?>" onKeyDown="limitText(this,45);" onKeyUp="limitText(this,45);" required/>
                    </div></div></div></div><hr>
		    ...
		    <div class="col-sm-5">
                    <div class="form-group">
                        <label for="inputMessage">Celular</label>
                        <input type="text" class="form-control" name="celular" value="<?php echo $fila['celular'] ?>" onkeyup="this.value=Numeros(this.value);" onKeyDown="limitText(this,10);" onKeyUp="limitText(this,10);" required/>
                    </div></div>
                    
                    <div class="col-sm-5">
                    <div class="form-group">
                        <label for="inputMessage">Dirección</label>
                        <input type="text" class="form-control"  name="direccion" value="<?php echo $fila['direccion'] ?>" onKeyDown="limitText(this,60);" onKeyUp="limitText(this,60);" required />
                    </div></div></div></div><hr>
		    ...
		    <div class="col-sm-5">
                    <div class="form-group">
                        <label for="inputMessage">Localidad</label>
                        <input type="text" class="form-control" name="localidad" value="<?php echo $fila['localidad'] ?>" onkeyup="this.value=Text(this.value);" onKeyDown="limitText(this,60);" onKeyUp="limitText(this,60);" required/>
                    </div></div>
                    
                    <div class="col-sm-5">
                    <div class="form-group">
                        <label for="inputMessage">Provincia</label>
                        <input type="text" class="form-control" name="provincia" value="<?php echo $fila['provincia'] ?>" onkeyup="this.value=Text(this.value);" onKeyDown="limitText(this,90);" onKeyUp="limitText(this,90);" required />
                    </div></div></div></div><hr>
